#ifndef __CCMDLINE_HPP_
#define __CMDLINE_HPP_
#include <string>
...
private:
public:
  unsigned long  int N,M,Nb,Mb,P,p,q,mb,nb,nt,ipn,to,ps,sil_dur,dlb_thr;
  ...
  CommandLine ( int n,int m , int nb , int mb , int P_, int p_, int q_,int mb_, int nb_, int nt_,bool dlb_,int ipn_);
